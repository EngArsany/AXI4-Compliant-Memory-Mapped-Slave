package AXI_write_golden_model_pkg;
  ...
  class axi4_golden_model;
    ...
    function new();
      foreach (shadow_mem[i]) shadow_mem[i] = 32'h0000_0000;
    endfunction
    ...
    function void predict(axi4_write_txn txn);
      ...
      last_byte_offset   = int'({1'b0, txn.awaddr[11:0]}) + (num_beats * stride) - 1;
      ...
      for (int i = 0; i < num_beats; i++) begin
        ...
        txn.beat_valid[i] = size_valid && start_in_range && in_range && !burst_crosses_4kb;
